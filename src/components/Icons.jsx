...
export function PersonPlaceholder() {
  return (
    <svg width="64" height="64" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30">
      <circle cx="30" cy="22" r="12" stroke="#C9A227" strokeWidth="1.5"/>
      <path d="M8 52c0-12.15 9.85-22 22-22s22 9.85 22 22" stroke="#C9A227" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  )
}
...
export function Icon({ name, size = 16 }) {
  ...
  if (name === 'email')    return <EmailIcon size={size} />
  return null
}
